/*! react-rating-anchors - 1.0.1 | (c) 2015, 2018  medwards81 | MIT | https://github.com/medwards81/react-rating-anchors */
	...
	var Rating = (function (_React$PureComponent) {
	  ...
	  _createClass(Rating, [{
	    ...
	    value: function render() {
	        ...
	        symbolNodes.push(_react2['default'].createElement(
	          ...
	          showScaleValue && _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'span',
	              { dir: 'ltr', style: _extends({ direction: 'ltr' }, valueStyle) },
	              currentVal
	            )
	          )
	        ));
	      ...
	      var middleScaleStyle = direction === 'ltr' ? { marginLeft: '10px' } : { marginRight: '10px' };

	      return _react2['default'].createElement(
	        'table',
	        { cellPadding: '0', style: { borderCollapse: 'collapse' } },
