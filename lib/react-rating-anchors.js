	    ...
	    value: function render() {
	      ...
	      for (var i = 0; i < totalSymbols; i++) {
	        ...
	        symbolNodes.push(_react2['default'].createElement(_RatingSymbol2['default'], {
	          ...
	          onMouseMove: !readonly && !anchors.length ? this.symbolMouseMove : _utilsNoop2['default'],
	          onTouchMove: !readonly && !anchors.length ? this.symbolMouseMove : _utilsNoop2['default'],
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'tbody',
	          null,
	          anchors.length && _react2['default'].createElement(
	            'tr',
	            null,
	            _react2['default'].createElement(
	              'td',
